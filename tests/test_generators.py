...
def test_card_number_generator():
    assert list(generators.card_number_generator(1, 5)) == [
        "0000 0000 0000 0001",
        "0000 0000 0000 0002",
        "0000 0000 0000 0003",
        "0000 0000 0000 0004",
    ...
    assert list(generators.card_number_generator(1, 1)) == ["0000 0000 0000 0001"]
    with pytest.raises(ValueError):
        assert list(generators.card_number_generator(-1, 5)) == ValueError
    with pytest.raises(ValueError):
        assert list(generators.card_number_generator(1, 10000000000000000)) == ValueError
