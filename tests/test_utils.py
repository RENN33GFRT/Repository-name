...
def test_get_transaction():
    ...
    json_file_path = os.path.join(current_dir, "..", "data", "transactions.json")
    json_file_path = os.path.abspath(json_file_path)
    assert get_transactions(json_file_path) == [
        {
            "id": 441945886,
            "state": "EXECUTED",
    ...
    assert get_transactions("ekD6W2FeAOpx9o19nO4kZGcd8wrejiBY") == []
    assert get_transactions(f"{os.getcwd()}\\data_test\\operations1.json") == []
    assert get_transactions(f"{os.getcwd()}\\data_test\\operations2.json") == []
